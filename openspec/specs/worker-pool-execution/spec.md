...
Define the host-owned, failure-atomic publication boundary for worker output,
including allowlist enforcement, recovery, retention, and clean rebuild behavior.
