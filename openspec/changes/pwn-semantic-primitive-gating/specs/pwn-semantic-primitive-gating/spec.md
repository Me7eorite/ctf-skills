...
- **AND** manual review may route the contract to triage but MUST NOT convert the unsupported contract into a governed pass
...
- **AND** only a bound manual review observation may accept that inconclusive supported-primitive case
