"""Run the design-tasks responsive HTML fixture through an existing Chrome CDP endpoint."""
...
FIXTURE_URL = "http://127.0.0.1:4186/tests/browser/design-tasks-responsive-fixture.html"
