...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("429 rate_limit error", "rate_limit"),
        ...
        ("insufficient_evidence:no_findings", "insufficient_evidence"),
        ...
        ("content_hash_dup:abc", "field_validation"),
        ...
        ("technique_family 'stack' is not allowed", "field_validation"),
