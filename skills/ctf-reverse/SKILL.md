...
- [wasm-mobile-managed.md](wasm-mobile-managed.md) - Recent reverse challenge patterns for WebAssembly, PyInstaller/Python bytecode, Android/JNI, Go/Rust managed runtimes, and VM/backdoor artifacts
