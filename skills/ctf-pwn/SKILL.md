...
- [modern-heap-and-sandbox.md](modern-heap-and-sandbox.md) - Recent pwn challenge patterns: tcache/UAF with heap+libc leaks, seccomp ORW, parent/child IPC sandbox escapes, static ROP, hybrid web-to-pwn services, and reliability-focused authoring notes
