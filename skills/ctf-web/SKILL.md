...
- [java-spring.md](java-spring.md) - Java web challenge patterns: Spring Boot, Thymeleaf/SpEL SSTI, WAR/Tomcat source recovery, Java deserialization, servlet/filter auth mistakes, and dependency/CVE-shaped Java bugs
- [python-frameworks.md](python-frameworks.md) - Python web challenge patterns: Flask/Jinja2 SSTI, Werkzeug/Flask session issues, pickle chains, Django/FastAPI auth mistakes, Python object pollution, and framework parser quirks
...
- [node-and-prototype.md](node-and-prototype.md) - Node.js and JavaScript challenge patterns: prototype pollution, Express parser/routing mismatch, VM/sandbox escape, unsafe merge/config gadgets, and runtime error/stack gadgets
...
- [github-advisory-patterns.md](github-advisory-patterns.md) - GitHub Advisory/GHSA/CVE-inspired web challenge patterns across npm, pip, Maven, Go archive tooling, SSRF, prototype pollution, deserialization, signed sessions, and upload/traversal bugs
