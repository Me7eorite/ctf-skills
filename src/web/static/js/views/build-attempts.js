...
const VALIDATION_DETAIL_LABELS = {
  compose_cross_talk: "Compose 并发串扰",
  pwn_bad_binary_path: "Pwn 二进制路径错误",
  pwn_payload_no_flag: "Payload 未取到 flag",
  pwn_bad_offset: "Pwn offset 错误",
